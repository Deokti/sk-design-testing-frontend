...
export const SKDesign = () => {
  return (
    <Wrapper>
      ...
      <Text>
        Ознакомиться с проектами можете в нашем <Link>портфолио</Link>. Если Вы
        оформляете интерьеры жилых или коммерческих помещений — мы с радостью
        поможем Вам: составим уникальные условия сотрудничества, предоставим 3D
        модели (уточняйте у менеджеров) и разработаем коммерческое предложение к
